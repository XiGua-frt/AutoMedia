...
"""
    ...
    # RAG：元数据提取 Prompt
    RAG_METADATA_EXTRACT_PROMPT = """你是一个内容分析专家，请从以下文章中提取结构化元数据。
...
{{
  "title": "文章标题",
  "enhanced_titles": ["爆款标题1", "爆款标题2", "爆款标题3"],
  "platform": "平台名",
  "category": "内容类别",
  "style": "内容风格",
  "tags": ["标签1", "标签2"],
...
"""
    ...
    # RAG：摘要与爆款要素 Prompt
    RAG_SUMMARY_PROMPT = """你是一个爆款内容研究专家，请分析以下文章的爆款要素。
严格按 JSON 格式返回，不要有任何其他内容。
...
{{
  "summary": "核心摘要",
  "structure_summary": "结构描述",
  "viral_elements": ["要素1", "要素2"],
  "key_quotes": ["金句1", "金句2"]
}}
"""
